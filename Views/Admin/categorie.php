...
$data = readAll("SELECT * FROM categorie");
if (isset($_GET['num'])) {
    extract($_GET);
    deleteca($num);
}
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10 b-bg">listes des categories</h5>
                                    </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="./categorieAdd.php" style="border: 1px solid;padding: 10px 25px; border-radius: 5px;"> <i class="feather icon-plus"></i> Ajouter une categorie</a>
                                        </div>
