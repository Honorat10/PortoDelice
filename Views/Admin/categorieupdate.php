...
extract($_GET);
$value = $bd->query("SELECT * FROM categorie WHERE id = $id")->fetch(PDO::FETCH_OBJ);
                                    ...
                                    <div class="card">
                                       ...
                                       <div class="card-body">
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <input type="text" class="form-control mb-0" aria-label="Nom" aria-describedby="inputGroup-sizing-sm" value="<?= $value->nom ?>" name="nom">
                                            </div>
