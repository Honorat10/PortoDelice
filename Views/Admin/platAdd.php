...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if(valideArray($_POST,['nom','prix','description','temps','categorie'])){
        ...
        $miniaturename = uniqid($_FILES["miniature"]["name"]);
           $destinationimage = "../Home/img/" . $imagename;
           $destinationminiature =  "../Home/img/" . $miniaturename;
      ...
      $query = $bd->prepare("INSERT INTO plat(nom,description,prix,temps,image,miniature,categorie_id) VALUE(?,?,?,?,?,?,?)" );
      $insert = $query->execute([$nom,$description,$prix,$temps,$destinationimage,$destinationminiature,$categorie]);
      if ($insert) {
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <input type="text" name="nom" class="form-control" aria-label="Nom" aria-describedby="inputGroup-sizing-sm">
                                            </div>
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="inputGroup-sizing-sm">Prix &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                </div>
                                                <input type="number" name="prix" class="form-control" aria-label="Prix" aria-describedby="inputGroup-sizing-sm">
                                            </div>
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <textarea  id="" name="description" cols="30" rows="10" class="form-control" aria-label="Prix" aria-describedby="inputGroup-sizing-sm"></textarea>
                                            </div>
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"  id="inputGroup-sizing-sm">Temps de preparation</span>
                                                </div>
                                                <input type="time" name="temps" class="form-control" aria-label="Prix" aria-describedby="inputGroup-sizing-sm">
                                            </div>
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="inputGroup-sizing-sm">Categorie &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                </div>
                                                <select name="categorie" id="" class="form-control" aria-label="Prix" aria-describedby="inputGroup-sizing-sm" >
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <input type="file" name="miniature" class="form-control" aria-label="Prix" aria-describedby="inputGroup-sizing-sm">
                                            </div>
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="inputGroup-sizing-sm">Image &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                </div>
                                                <input type="file" name = "image" class="form-control" aria-label="Prix" aria-describedby="inputGroup-sizing-sm">
                                            </div>
                                            <br>
