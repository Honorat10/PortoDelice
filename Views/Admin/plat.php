                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10 b-bg">listes des plats disponible</h5>
                                    </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="./platAdd.php" style="border: 1px solid;padding: 10px 25px; border-radius: 5px;"> <i class="feather icon-plus"></i> Ajouter un nouveau plat</a>
                                        </div>
